                          ...
                          <tbody>
                            @foreach ($owners as $owner)
                              <tr>
                                ...
                                <td class="px-4 py-3">
                                  <button onclick="location.href='{{ route('admin.owners.edit', ['owner' => $owner->id]) }}'" class="text-white bg-blue-400 border-0 py-2 px-4 focus:outline-none hover:bg-blue-500 rounded">編集する</button>
                                </td>
                              </tr>
                            @endforeach
                          </tbody>
