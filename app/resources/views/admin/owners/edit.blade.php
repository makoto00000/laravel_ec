              ...
              <div class="lg:w-1/2 md:w-2/3 mx-auto">
                ...
                <form method="post" action="{{ route('admin.owners.update', ['owner' => $owner->id]) }}">
                  ...
                  <div class="-m-2">
                    ...
                    <div class="p-2 w-1/2 mx-auto">
                      <div class="relative">
                        <label for="for" class="leading-7 text-sm text-gray-600">店名</label>
                        <div class="w-full  focus:bg-white focus:ring-2 focus:ring-blue-200 text-base outline-none text-gray-700 py-1 px-3 leading-8 transition-colors duration-200 ease-in-out">
                          {{ $owner->shop->name }}
                        </div>
                      </div>
                    </div>
